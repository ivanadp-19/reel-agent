...
export const Editor: React.FC<{onBackToStart: () => void}> = ({onBackToStart}) => {
  ...
  const [exp, setExp] = useState<{status: string; jobId?: string; progress?: number; file?: string; qc?: string; label?: string; etaSec?: number | null; version?: number; versionError?: string} | null>(null);
