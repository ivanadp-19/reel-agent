...
- `src/transitions.ts` — how a clip starts (cut, punch, zoom, whip, whipDiag, card, split) and stepped speed ramps; `set_transitions`, `set_speed_ramp`; `scripts/sfx.mjs` synthesizes the whoosh / thud / pop (`set_audio sfx`)
